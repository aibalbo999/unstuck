...
def test_shared_quality_evidence_helper_loads_before_all_consumers():
    ...
    assert "/static/history_quality_audit_render.js?v=20260902-returned-items-bounds" in index_html
    ...
    assert "/static/watchlist_panel_helpers.js?v=20260902-integer-quality-detail-counts" in index_html
