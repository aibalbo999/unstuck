...
def test_shared_quality_evidence_helper_loads_before_all_consumers():
    ...
    assert "/static/history_current_quality_helpers.js?v=20260902-bounded-items" in index_html
    ...
    assert "/static/watchlist_panel_helpers.js?v=20260902-quality-coverage" in index_html
