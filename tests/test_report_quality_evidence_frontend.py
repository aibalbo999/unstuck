...
def test_shared_quality_evidence_helper_loads_before_all_consumers():
    ...
    assert "/static/history_current_quality_helpers.js?v=20260902-non-passed-scope" in index_html
    assert "/static/watchlist_freshness_helpers.js?v=20260902-integer-quality-counts" in index_html
    assert "/static/watchlist_current_quality_helpers.js?v=20260902-non-passed-scope" in index_html
