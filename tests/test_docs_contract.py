...
def test_report_quality_docs_cover_snapshot_integrity_contract():
    ...
    for document in [api_reference, operator_guide]:
        ...
        assert "quality_metadata_missing_by_rerun_context" in document
...
def test_runtime_docs_cover_notification_delivery_audit_store():
    ...
    for expected in [
        ...
        "core_critical_covered_count",
        "core_critical_uncovered_count",
        ...
        "Report recommendation legacy text uses event metadata fallback for single-character next catalysts",
        ...
        "Report structured-output trade-plan direct schema preserves enum and required-field strictness",
        ...
        "Report structured-output runtime parsing rejects non-JSON structured responses",
        "Report structured-output normalizer rejects incomplete supplied core sections",
        ...
        "Report Agent 19 required structured trigger rows guard single-character fragments",
        ...
        "Report recommendation block skips single-character display keys",
        ...
        "Report Agent 19 recommendation ordered values guard single-character fragments",
        ...
        "Report recommendation legacy analysis bodies use fallback for single-character fragments",
        ...
        "Report valuation legacy text skips single-character valuation reasoning fragments",
        ...
        "Report moat score legacy text uses value fallback for single-character fragments",
        ...
        "Report structured-output normalization analysis bodies use string-only fallback",
        "Report structured-output schema analysis bodies use string-only fallback",
        "Report structured-output schema executive thesis fields use string-only fallback",
        "Report structured-output normalization display fields use string-only fallback",
        "Report structured-output schema display fields use string-only fallback",
        "Report structured-output schema valuation and recommendation text fields use string-only fallback",
        "Report structured-output schema DCF scenario names use string-only enum fallback",
        "Report structured-output schema boolean fields use string-only coercion",
        "Report structured-output normalization boolean fields use string-only coercion",
        "Report structured-output schema numeric fields use primitive-only coercion",
        "Report structured-output normalization numeric fields use primitive-only coercion",
        "Report structured-output schema recommendation keys and labels use string-only routing",
        "Report structured-output normalization recommendation keys and labels use string-only routing",
        "Report structured-output schema alias lookups use string-only mapping keys",
        "Report structured-output schema field lookups use string-only mapping keys",
        "Report structured-output normalization alias lookups use string-only mapping keys",
        "Report recommendation block legacy text uses primitive-only display fallback",
        "Report recommendation tail legacy next-catalyst text uses primitive-only display fallback",
        "Report recommendation legacy reasoning steps use primitive-only display fallback",
        "Report recommendation legacy confidence basis uses primitive-only display fallback",
        "Report Agent 19 required-section trigger directions use primitive-only enum checks",
        "Report structured-output normalization nested display rows use string-only fallback",
        "Report structured-output normalization valuation display fields use string-only fallback",
        "Report structured-output normalization recommendation tail fields use string-only fallback",
        "Report structured-output schema recommendation tail fields use string-only fallback",
        "Report structured-output normalization reasoning steps use string-only fallback",
        "Report structured-output normalization confidence basis fields use string-only fallback",
        "Report legacy score and valuation analysis bodies use fallback for single-character fragments",
