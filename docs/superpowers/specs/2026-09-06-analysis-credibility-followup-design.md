...
日期：2026-09-06。方向與本書面規格均已獲使用者「同意／核准」；第一批程式、TDD 回歸與獨立審查已完成。完整隔離驗證與發布邊界見 `docs/four-mode-credibility-delivery-2026-09-06.md`；正式重啟與歷史報告重建不在本批。
...
本文件定義核准契約；實際完成證據以實作計畫與交付驗證紀錄為準，不代表正式 runtime 或歷史報告已更新。
