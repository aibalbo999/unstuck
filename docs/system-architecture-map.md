...
- historical quality audit renderer 對 audit、gap、provenance、rerun、review、version、artifact、snapshot、pipeline 與 bounded item counts 採有限非負整數邊界；fractional/malformed 值不渲染，核心範圍不完整時顯示「資料需確認」，不以 `floor` 產生假報告數。
