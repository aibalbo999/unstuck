...
_FIELD_HINTS: tuple[tuple[tuple[str, ...], tuple[str, ...]], ...] = (
    ...
    (("Return Today", "Borrowed Short Return Today", "Today's borrowed short return"), ("borrowed_short_return_today", "shares_to_lots", "shares_to_millions")), (("Retail",), ("retail_holders_lt_50_lots_pct",)),
