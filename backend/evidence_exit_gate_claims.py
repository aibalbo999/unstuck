...
_FIELD_HINTS: tuple[tuple[tuple[str, ...], tuple[str, ...]], ...] = (
    ...
    (("Return Today", "Borrowed Short Return Today", "Today's borrowed short return"), ("borrowed_short_return_today", "shares_to_lots", "shares_to_millions")), (("Retail",), ("retail_holders_lt_50_lots_pct",)), (("Holders < 50 lots",), ("retail_holders_lt_50_lots_pct",)), (("Holders > 1000 lots", "Holders > 1,000 lots", "Major > 1000 lots", "Major > 1,000 lots"), ("major_holders_gt_1000_lots_pct",)), (("Equity Multiplier", "權益乘數"), ("equity_multiplier",)),
...
def _path_markers_for_claim(claim: dict[str, Any]) -> tuple[str, ...]:
    ...
    if "factset" in raw_text:
        return ("factset",)
    if any(marker in raw_text for marker in _NORMALIZED_RESEARCH_CONTEXT_MARKERS) or ("sp500" in raw_text and "台股加權指數" in raw_text and "change1d" in raw_text):
    ...
    if "last_5_trading_days_net_buy_thousand_shares" in raw_text or label in ("last5tradingdaysnetbuy", "last5daysnetbuy"):
        return ("institutional_trading.last_5_trading_days_net_buy_thousand_shares",)
