...
_FIELD_HINTS: tuple[tuple[tuple[str, ...], tuple[str, ...]], ...] = (
    ...
    (("停損", "止損", "stoploss", "stop_loss"), ("stop_loss", "stoploss", "risk_price")), (("借券餘額",), ("borrowed_short_sale_balance",)), (("當日借券賣出", "borrowed short sale today", "borrowed_short_sale_today"), ("borrowed_short_sale_today", "shares_to_millions")), (("vs Sale Today",), ("borrowed_short_sale_today", "shares_to_thousands", "shares_to_millions")),
    (("Return Today", "Borrowed Short Return Today", "Today's borrowed short return"), ("borrowed_short_return_today", "shares_to_lots", "shares_to_millions")), (("Retail",), ("retail_holders_lt_50_lots_pct",)), (("Equity Multiplier", "權益乘數"), ("equity_multiplier",)),
    ...
    (("forwardpe", "forward pe"), ("forward_pe", "forwardpe", "forward_eps")), (("epsimpliedrevenuegrowth", "impliedrevenuegrowth"), ("forward_eps_implied_revenue_growth_pct", "implied_revenue_growth_pct")), (("incomegrowthlatestannual", "latest annual net income growth"), ("latest_annual_net_income_growth",)),
