(function () {
    ...
    function render(summary, escapeHtml) {
        ...
        const evidenceReasonFreshnessSummary = window.StockAgentReportQualityEvidence?.formatUnverifiableReasonFreshnessSummary?.(summary.evidence_unverifiable_reason_counts_by_freshness, summary.evidence_unverifiable_reports_by_freshness) || '';
