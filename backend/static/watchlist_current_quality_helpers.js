(function () {
    ...
    function summary(audit) {
        ...
        const evidenceReasonFreshnessSummary = window.StockAgentReportQualityEvidence?.formatUnverifiableReasonFreshnessSummary?.(data.summary.evidence_unverifiable_reason_counts_by_freshness, data.summary.evidence_unverifiable_reports_by_freshness) || '';
        ...
        const qualityActionSummary = window.StockAgentReportQualityActionScope?.formatQualityActionProjectionSummary?.(data.summary.quality_gate_action_counts, data.summary.quality_gate_action_scope) || window.StockAgentReportQualityEvidence?.formatQualityActionSummary?.(data.summary.quality_gate_action_counts) || '';
