(function () {
    ...
    function summary(audit) {
        ...
        const failedCount = positiveInteger(data.summary.evidence_failed_count), evidenceFailureSummary = failedCount !== null ? `證據數值不一致 ${failedCount}` : '';
