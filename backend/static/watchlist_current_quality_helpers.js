(function () {
    ...
    function summary(audit) {
        ...
        const evidenceReasonFreshnessSummary = window.StockAgentReportQualityEvidence?.formatUnverifiableReasonFreshnessSummary?.(data.summary.evidence_unverifiable_reason_counts_by_freshness) || '';
