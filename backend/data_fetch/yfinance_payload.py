...
def build_legacy_payload(ctx: dict) -> dict:
    ...
    return {
        ...
        "company_summary": ctx["company_summary"],
        "website": ctx["website"],
        "exchange": ctx["exchange"],
        "currency": ctx["currency"],
        "financial_currency": ctx["financial_currency"],
        "sector": ctx["sector"],
        ...
        "shares_outstanding_raw": ctx["shares_outstanding"],
        "shares_raw": ctx["shares_outstanding"],
        "float_shares": ctx["float_shares"],
        "held_percent_insiders": ctx["held_percent_insiders"],
        "held_percent_institutions": ctx["held_percent_institutions"],
        "shares_short": ctx["shares_short"],
        "short_ratio": ctx["short_ratio"],
        "short_percent_of_float": ctx["short_percent_of_float"],
