...
TECH_PROXY_SYMBOLS = (
    ...
    ("^TNX", "US 10Y Treasury Yield", "rates"),
    ("DX-Y.NYB", "US Dollar Index", "fx"),
    ("CL=F", "WTI Crude Oil Futures", "commodity_energy"),
    ("GC=F", "Gold Futures", "commodity_safe_haven"),
    ("^TWII", "Taiwan Weighted Index", "regional_taiwan"),
    ("EWT", "iShares MSCI Taiwan ETF", "regional_taiwan"),
    ("EWJ", "iShares MSCI Japan ETF", "regional_asia"),
    ("EWY", "iShares MSCI South Korea ETF", "regional_asia"),
