...
def _generate_openai_content(api_key: str, model_id: str, prompt: str, config) -> TextLLMResponse:
...
def _generate_anthropic_content(api_key: str, model_id: str, prompt: str, config) -> TextLLMResponse:
