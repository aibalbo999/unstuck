...
SOURCE_LABELS = {
    ...
    "chip_data": "深度籌碼",
    "alternative_data": "另類數據",
    "social_sentiment": "社群討論情緒",
    "sec_edgar": "SEC EDGAR filings",
    "taiwan_open_data": "台灣開放資料",
    "official_disclosures": "交易所官方公告",
    "peer_discovery": "同業搜尋",
...
AUDIT_STATUS_LABELS = {
    ...
    AUDIT_STATUS_NOT_CONFIGURED: "未設定",
    AUDIT_STATUS_DEGRADED_ENRICHMENT: "補充降級",
}
