...
AGENT_RAG_QUERIES = {
    1: "business model revenue segments supply chain customers product mix management strategy",
    2: "five year financial statements revenue margin free cash flow balance sheet debt profitability",
    3: "competitive moat peers switching costs technology patents cost advantage market share",
    4: "valuation DCF WACC FCF PE multiple target price capex margin assumptions",
    5: "growth drivers TAM demand catalysts capacity AI technology long term opportunity risks",
    6: "bull bear debate catalysts risks valuation controversy downside upside counterarguments",
    7: "final investment decision recommendation target price confidence risks catalysts valuation",
}
