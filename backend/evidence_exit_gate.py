...
_SCENARIO_TARGET_LABELS = frozenset(("熊市情境", "基本情境", "牛市情境", "熊基牛情境")); _TECHNICAL_LEVEL_LABELS = frozenset(("心理關卡", "第二支撐", "關鍵支撐區"))
