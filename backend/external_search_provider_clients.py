...
from search_provider_runtime import observe_http_response
from search_response_validation import (
    observed_json_get as _async_json_get, response_json as _response_json,
    validate_payload as _validate_payload, validate_rss as _validate_rss,
)
...
async def _fetch_bing_results(client, query: str, *, max_results: int) -> list[SearchResult]:
    ...
    _validate_payload(payload, "webPages")
...
async def _fetch_tavily_results(client, query: str, *, max_results: int) -> list[SearchResult]:
    ...
    _validate_payload(payload, "results")
    return parse_tavily_payload(payload)
...
async def _fetch_serpapi_results(client, query: str, *, max_results: int) -> list[SearchResult]:
    ...
    _validate_payload(payload, "organic_results", allow_empty="search_metadata")
...
async def _fetch_gdelt_results(
    ...
    *,
    ...
    _validate_payload(payload, "articles")
