"""Legacy context adapters for LangGraph workflow services."""
...
def legacy_context_from_graph(state: AgentGraphState, services: Any) -> AnalysisContext:
    ...
    context: AnalysisContext = {
        ...
        "position_sizing_context": copy_json(state.get("position_sizing_context") or {}),
        ...
        "repair_candidate_history": copy_json(state.get("repair_candidate_history") or {}),
...
def graph_delta_from_legacy_context(context: AnalysisContext) -> dict[str, Any]:
    ...
    delta: dict[str, Any] = {
        ...
        "position_sizing_context": copy_json(context.get("position_sizing_context") or {}),
        ...
        "repair_candidate_history": copy_json(context.get("repair_candidate_history") or {}),
        "agent_quality_retry_counts": graph_agent_mapping(context.get("agent_quality_retry_counts") or {}),
...
def input_data_from_state(state: AgentGraphState) -> dict[str, Any]:
...
def graph_agent_mapping(mapping: dict[Any, Any]) -> dict[str, Any]:
