...
LOCAL_BLOCK_KINDS = {"ModelCircuitOpenError", "ProviderCongestionError", "AllKeysRpdDisabledError", "InputCapacityExceededError", "DailyBudgetBlockedError", "ToolRequestGuardError", "KeyAdmissionTimeout"}
