...
def _strip_non_price_tokens(text: str) -> str:
    ...
    return _NON_PRICE_METRIC_VALUE_RE.sub("", NON_PRICE_TARGET_METRIC_VALUE_PATTERN.sub("", QUALITY_SERVICE_QUEUE_METRIC_VALUE_PATTERN.sub("", QUALITY_SERVICE_TIME_TO_METRIC_PERMUTATION_VALUE_PATTERN.sub("", QUALITY_SERVICE_TIME_TO_METRIC_VALUE_PATTERN.sub("", without_people_compliance_acknowledgment)))))
